...
function __wbg_adapter_12(arg0, arg1) {
    wasm._dyn_core__ops__function__FnMut_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__ha60ec12b0e1a88aa(arg0, arg1);
}
...
* @returns {Handle}
*/
__exports.init = function(w, h, s) {
    const ptr0 = passArray8ToWasm0(s, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.init(w, h, ptr0, len0);
...
* @param {Uint8Array} s
*/
__exports.update = function(h, s) {
    _assertClass(h, Handle);
    const ptr0 = passArray8ToWasm0(s, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
    wasm.update(h.ptr, ptr0, len0);
};
...
async function init(input) {
    ...
    imports.wbg.__wbindgen_closure_wrapper44 = function(arg0, arg1, arg2) {
        const ret = makeMutClosure(arg0, arg1, 11, __wbg_adapter_12);
        return addHeapObject(ret);
    };
