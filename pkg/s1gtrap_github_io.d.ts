...
declare interface InitOutput {
  ...
  readonly _dyn_core__ops__function__FnMut_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__ha60ec12b0e1a88aa: (a: number, b: number) => void;
